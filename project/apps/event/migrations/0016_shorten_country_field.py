...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column(u'event_eventdate', 'country', self.gf('django_countries.fields.CountryField')(max_length=2, null=True))

    def backwards(self, orm):
        db.alter_column(u'event_eventdate', 'country', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        u'event.eventdate': {
            ...
            'state': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'timezone_new': ('timezone_field.fields.TimeZoneField', [], {'default': "'UTC'"}),
