...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Currency.country'
        db.delete_column(u'event_currency', 'country')

        # Deleting field 'Currency.country_code'
        db.delete_column(u'event_currency', 'country_code')


    def backwards(self, orm):
        # Adding field 'Currency.country'
        db.add_column(u'event_currency', 'country',
                      self.gf('django.db.models.fields.CharField')(default='dummy', max_length=64, unique=True),
                      keep_default=False)

        # Adding field 'Currency.country_code'
        db.add_column(u'event_currency', 'country_code',
