...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Event', fields ['short_link']
        db.create_unique(u'event_event', ['short_link'])

        # Adding M2M table for field shared on 'EventDate'
        m2m_table_name = db.shorten_name(u'event_eventdate_shared')
        ...
        db.create_unique(m2m_table_name, ['eventdate_id', 'userprofile_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Event', fields ['short_link']
        db.delete_unique(u'event_event', ['short_link'])

        # Removing M2M table for field shared on 'EventDate'
        db.delete_table(db.shorten_name(u'event_eventdate_shared'))
