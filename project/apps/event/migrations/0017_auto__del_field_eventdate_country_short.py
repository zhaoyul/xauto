...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EventDate.country_short'
        db.delete_column(u'event_eventdate', 'country_short')


    def backwards(self, orm):
        # Adding field 'EventDate.country_short'
        db.add_column(u'event_eventdate', 'country_short',
