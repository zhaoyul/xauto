...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'event_eventdate', (
            ...
            ('location_name', self.gf('django.db.models.fields.CharField')(default='', max_length=250, null=True, blank=True)),
            ...
            ('address_1', self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True, blank=True)),
            ...
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(related_name='event_dates', to=orm['event.Event'])),
        ...
        db.create_table(u'event_event', (
            ...
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='authored_event', null=True, to=orm['account.UserProfile'])),
            ...
            ('short_link', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
            ('main_image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='main', null=True, on_delete=models.SET_NULL, to=orm['event.EventImage'])),
        ))
