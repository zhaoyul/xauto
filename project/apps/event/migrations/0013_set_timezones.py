...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for event_date in orm.EventDate.objects.all():
            event_date.timezone_new = TIME_ZONES.get(event_date.timezone, 'America/Los_Angeles')
            event_date.save()
