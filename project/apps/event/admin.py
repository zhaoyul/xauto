...
class EventDateAdmin(admin.ModelAdmin):
    ...
    fields = ('event', 'location_name', 'address_1', 'address_2', 'country', 'country_short', 'city' , 'state', 'region', 'zipcode', 'latitude', 'longitude', 'start_date', 'end_date', 'timezone', 'feature_headline', 'feature_detail', 'currency' , 'attend_free', 'attend_price_from', 'attend_price_to', 'exhibit_free',  'exhibit_price_from', 'exhibit_price_to')
