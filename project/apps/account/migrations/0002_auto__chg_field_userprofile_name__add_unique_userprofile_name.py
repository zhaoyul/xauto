...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field followed on 'UserProfile'
        m2m_table_name = db.shorten_name(u'account_userprofile_followed')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_userprofile', models.ForeignKey(orm[u'account.userprofile'], null=False)),
            ('to_userprofile', models.ForeignKey(orm[u'account.userprofile'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_userprofile_id', 'to_userprofile_id'])


        # Changing field 'UserProfile.name'
        db.alter_column(u'account_userprofile', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))
        # Adding unique constraint on 'UserProfile', fields ['name']
        db.create_unique(u'account_userprofile', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserProfile', fields ['name']
        db.delete_unique(u'account_userprofile', ['name'])

        # Removing M2M table for field followed on 'UserProfile'
        db.delete_table(db.shorten_name(u'account_userprofile_followed'))


        # Changing field 'UserProfile.name'
        db.alter_column(u'account_userprofile', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
