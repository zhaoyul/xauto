...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.activationtoken'
        db.add_column(u'account_userprofile', 'activationtoken',
                      self.gf('django.db.models.fields.CharField')(max_length=255L, null=True, db_column='activationToken', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.activationtoken'
        db.delete_column(u'account_userprofile', 'activationToken')
