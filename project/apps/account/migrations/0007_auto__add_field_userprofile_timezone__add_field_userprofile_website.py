...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'account_userprofile', 'timezone',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.website'
        db.add_column(u'account_userprofile', 'website',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'account_userprofile', 'timezone')

        # Deleting field 'UserProfile.website'
        db.delete_column(u'account_userprofile', 'website')
