...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'account_userprofile', 'country', self.gf('django_countries.fields.CountryField')(max_length=2, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.country'
        db.alter_column(u'account_userprofile', 'country', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
