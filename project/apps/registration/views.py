...
from xauto.auth.forms import HoneypotForm
...
def register(request, backend, success_url=None, form_class=None,
    ...
    **Template:**
    ...
    if 'is_join' in request.POST:
        template_name = 'join_registration_form.html'
    ...
    if request.method == 'POST':
        ...
        if is_honeypot_form_valid and is_main_form_valid:
            ...
            if success_url is None:
                ...
                # --- Custom for xauto ---
                context = RequestContext(request)
                return render_to_response(template_name,  { 'register_complete': '1', 'new_user' : new_user }, context_instance=context)
    ...
    return render_to_response(template_name,
                              { 'form': form, 'honeypot_form': honeypot_form },
                              context_instance=context)
