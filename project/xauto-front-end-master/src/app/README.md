...
As `blvdx` is quite minimal, take a look at the two provided submodules
...
```js
.config( function blvdxConfig ( $routeProvider ) {
...
One of the design philosophies of `blvdx` is that tests should exist
