...
angular.module("account/partial_create_account.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("account/partial_create_account.tpl.html",
    ...
    "    </div>\n" +
    "  </div>\n" +
    "  <div class=\"form-group\" ng-class=\"{'has-error': form.username.$invalid || errors.username || AccountObj.username_available == 'Unavailable'}\">\n" +
    "    <label class=\"col-lg-3 control-label\">Username</label>\n" +
    "    <div class=\"col-lg-6\">\n" +
    "      <input name=\"username\" ng-keyup=\"checkUsername($event.target.value)\" type=\"text\" class=\"form-control\" placeholder=\"\"\n" +
    "             ng-model=\"AccountObj.user.username\" ng-keyup=\"checkUsername($event.target.value)\" ng-maxlenght=\"255\">\n" +
    "      <span class=\"help-block\" ng-show=\"errors.username\" ng-repeat=\"error in errors.username\">{{error}}</span>\n" +
    "    </div>\n" +
    "    <div class=\"col-lg-3\">\n" +
